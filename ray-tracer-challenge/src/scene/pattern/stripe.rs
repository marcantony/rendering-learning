...
mod tests {
    ...
    fn a_stripe_pattern_is_constant_in_y() {
        ...
        assert_eq!(
            pattern.at_local(&Point3d::new(0.0, 1.0, 0.0)),
            color::white()
        );
        assert_eq!(
            pattern.at_local(&Point3d::new(0.0, 2.0, 0.0)),
            color::white()
        );
    }
    ...
    fn a_stripe_pattern_is_constant_in_z() {
        ...
        assert_eq!(
            pattern.at_local(&Point3d::new(0.0, 0.0, 2.0)),
            color::white()
        );
    }
    ...
    fn a_stripe_pattern_alternates_in_x() {
        ...
        assert_eq!(
            pattern.at_local(&Point3d::new(0.9, 0.0, 0.0)),
            color::white()
        );
        assert_eq!(
        ...
        assert_eq!(
            pattern.at_local(&Point3d::new(-0.1, 0.0, 0.0)),
            color::black()
        );
        assert_eq!(
            pattern.at_local(&Point3d::new(-1.0, 0.0, 0.0)),
        ...
        assert_eq!(
            pattern.at_local(&Point3d::new(-1.1, 0.0, 0.0)),
            color::white()
        );
    }
}
